// set-android-env-crossplat.js
// Idempotent script that always overwrites ANDROID_HOME and platform-tools on both Windows and macOS/Linux
...
function setupUnix() {
  ...
  console.log('▶️ Run `source', rcFile, '` or restart your shell for changes.');
}
